...
public class PgEdittrip extends Page {
	...
	private class EditTripPane {
		...
		EditTripPane(Trip trip) {
			...
			TextField startingPoint = new TextField(trip != null ? trip.getStart() : "");
			...
			TextField dest = new TextField(trip != null ? trip.getDest() : "");
			...
			TextField arrivalTime = new TextField(trip != null ? trip.getArriveTime() : "");
			...
			TextField commuteTime = new TextField(trip != null ? trip.getLeaveTime() : "");
